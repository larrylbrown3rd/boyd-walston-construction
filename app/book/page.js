        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              <p className="font-bebas text-6xl md:text-7xl text-[#111111] mb-3">01</p>
            ...
            <div className="text-center">
              <p className="font-bebas text-6xl md:text-7xl text-[#111111] mb-3">02</p>
              <h3 className="font-inter font-semibold text-sm text-[#111111] mb-2">
                We Come To You
              </h3>
              <p className="font-inter text-sm text-[#9B9B9B]">
            ...
            <div className="text-center">
              <p className="font-bebas text-6xl md:text-7xl text-[#111111] mb-3">03</p>
              <h3 className="font-inter font-semibold text-sm text-[#111111] mb-2">
                Get Your Quote
              </h3>
              <p className="font-inter text-sm text-[#9B9B9B]">
