      ...
      <section className="py-24 px-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="border border-[#E8E8E8] p-16 text-center mb-16">
            ...
            <p className="font-sans text-sm text-[#9B9B9B] mb-8 max-w-md mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="tel:5550000000"
                className="bg-[#111111] text-white font-sans text-sm px-8 py-4 rounded-full hover:bg-[#2C2C2C] transition-colors"
              >
                Call Us Now
              </a>
              <a
                href="/contact"
                className="border border-[#111111] text-[#111111] font-sans text-sm px-8 py-4 rounded-full hover:bg-[#111111] hover:text-white transition-colors"
              >
                Send A Message
              </a>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              <p className="font-serif text-4xl text-[#111111] mb-3">01</p>
              <h3 className="font-sans font-semibold text-sm text-[#111111] mb-2">
                Book Your Slot
              </h3>
            ...
            <div className="text-center">
              <p className="font-serif text-4xl text-[#111111] mb-3">02</p>
              <h3 className="font-sans font-semibold text-sm text-[#111111] mb-2">
                We Come To You
              </h3>
              <p className="font-sans text-sm text-[#9B9B9B]">
            ...
            <div className="text-center">
              <p className="font-serif text-4xl text-[#111111] mb-3">03</p>
              <h3 className="font-sans font-semibold text-sm text-[#111111] mb-2">
                Get Your Quote
              </h3>
              <p className="font-sans text-sm text-[#9B9B9B]">
