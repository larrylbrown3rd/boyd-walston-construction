      ...
      <section className="py-24 px-8">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16">
          <div>
            ...
            <p className="font-inter text-[#9B9B9B] leading-relaxed mb-4">
            ...
            <p className="font-inter text-[#9B9B9B] leading-relaxed">
          ...
          <div className="grid grid-cols-2 gap-8">
            <div className="bg-white border border-[#E8E8E8] p-8 text-center">
              <p className="font-playfair text-4xl text-[#111111] mb-2">10+</p>
              <p className="font-inter text-xs tracking-[0.15em] uppercase text-[#9B9B9B]">Years Experience</p>
            </div>
            <div className="bg-white border border-[#E8E8E8] p-8 text-center">
              <p className="font-playfair text-4xl text-[#111111] mb-2">200+</p>
              <p className="font-inter text-xs tracking-[0.15em] uppercase text-[#9B9B9B]">Projects Completed</p>
            </div>
            <div className="bg-white border border-[#E8E8E8] p-8 text-center">
              <p className="font-playfair text-4xl text-[#111111] mb-2">100%</p>
              <p className="font-inter text-xs tracking-[0.15em] uppercase text-[#9B9B9B]">Client Satisfaction</p>
            </div>
            <div className="bg-white border border-[#E8E8E8] p-8 text-center">
              <p className="font-playfair text-4xl text-[#111111] mb-2">AL</p>
              <p className="font-inter text-xs tracking-[0.15em] uppercase text-[#9B9B9B]">Licensed & Insured</p>
            </div>
          </div>
        </div>
      </section>
