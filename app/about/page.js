    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="bg-[#111111] text-white py-24 px-8 relative overflow-hidden">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <div style={{ zIndex: 2, position: 'relative' }}>
            ...
            <p className="font-sans text-lg text-[#9B9B9B] max-w-lg">
      ...
      <section className="py-24 px-8">
        <div className="max-w-6xl mx-auto">
          <ScrollReveal>
            <h2 className="font-serif text-3xl text-[#111111] mb-6">
              Our Story
            </h2>
            <p className="font-sans text-[#9B9B9B] leading-relaxed mb-4 max-w-3xl">
            ...
            <p className="font-sans text-[#9B9B9B] leading-relaxed max-w-3xl">
