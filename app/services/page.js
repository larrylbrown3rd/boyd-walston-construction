        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <ScrollReveal delay={0}>
            <div className="bg-white border border-[#E8E8E8] p-10 hover:border-[#111111] hover:shadow-sm hover:-translate-y-1 transition-all duration-300">
              <h2 className="font-serif text-xl text-[#111111] mb-4">
                Residential Construction
              </h2>
              <p className="font-sans text-sm text-[#9B9B9B] leading-relaxed mb-6">
              ...
              <ul className="font-sans text-sm text-[#9B9B9B] space-y-2 list-none">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="font-sans text-[#9B9B9B] leading-relaxed mb-8">
              ...
              <a
                href="/estimate"
                className="inline-block bg-white text-[#111111] font-sans font-semibold text-xs px-8 py-4 rounded-full hover:bg-[#F0EFED] transition-colors"
              >
                Start Planning →
              </a>
            </div>
