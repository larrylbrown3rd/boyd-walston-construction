      ...
      <div className="max-w-6xl mx-auto">
        <ScrollReveal>
          <div className="max-w-2xl mb-16">
            <p className="text-eyebrow text-sm mb-4">Simple Process</p>
            ...
            <p className="font-lato text-base md:text-lg font-normal text-[#4A4A4A] leading-relaxed">
              Most homeowners delay because the process feels overwhelming.
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-14">
          {steps.map((step, i) => (
            <ScrollReveal key={step.number} delay={i * 0.12}>
              <div className="border border-[#E8E8E8] p-8 h-full hover:border-[#111111] transition-colors duration-300">
                <p className="text-display text-4xl text-[#D4D4D4] mb-4">
                  {step.number}
                </p>
        ...
        <ScrollReveal>
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6 bg-[#F8F7F5] border border-[#E8E8E8] p-8">
            <div className="flex-1">
              <p className="font-lato text-sm font-semibold text-[#111111] mb-1">
